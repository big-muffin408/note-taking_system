...
知识爆炸时代，学生和科研人员面临 “收藏从未停止，阅读从未开始” 的困境。本项目打造以 AI 为核心驱动的协作笔记平台，打破 PDF 静态文件与动态笔记隔阂，实现 “输入 (PDF)- 处理 (AI)- 产出 (Markdown 协作)” 闭环。
...
采用 “边端协同” 架构，核心为 “前端托管 + 云端数据 + 本地算力 / 模型服务商” 异构部署。

### 3.1 协同编辑与富文本编辑器

|   组件   |                             说明                             |                 链接                 |
| :------: | :----------------------------------------------------------: | :----------------------------------: |
|   Yjs    | 高性能 CRDT 协同引擎，支持多人实时编辑、离线协作，与多编辑器深度集成 |      https://github.com/yjs/yjs      |
...
![image-20260326181827878](/Users/big_muffin/Library/Application Support/typora-user-images/image-20260326181827878.png)
...
|       AI 服务       | 0.4 核 / 512M | 本地Ollama大模型部署/调用外部 API，消耗在网络 I/O，内存需求低 |
...
![image-20260326182154592](/Users/big_muffin/Library/Application Support/typora-user-images/image-20260326182154592.png)
...
- 智能导入：支持 PDF 拖拽上传，自动提取纯文本并按标题分段
- 一键摘要：针对选中的 PDF 段落或全文生成
- 部署架构：采用 Docker 的微架构部署方案
