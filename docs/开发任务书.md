...
flowchart TD
    ...
    subgraph Server ["实际使用云服务器：2核4G Docker + Docker compose"]
        ...
        Qdrant[(向量数据库 Qdrant<br/>容器 · 1核/4G · 6333)]
    ...
    class Nginx,Frontend,Sync,UserSrv,Collab,Doc,AISrv,MySQL,MongoDB,Redis,Qdrant,MinIO,User,ExternalAI box
```
...
| 向量数据库 (Qdrant) | 0.3 核 / 512M |       内存随向量数据增长，需预留空间       |
